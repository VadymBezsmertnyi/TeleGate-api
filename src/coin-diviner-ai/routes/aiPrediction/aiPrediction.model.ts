...
const goldAnalysisSM = new Schema(
  {
...
const macroEconomicFactorsSM = new Schema(
  {
...
const marketMetricsSM = new Schema(
  {
...
const technicalIndicatorsSM = new Schema(
  {
...
const marketContextSM = new Schema(
  {
    ...
    gold_analysis: { type: goldAnalysisSM, required: true },
    macro_economic_factors: { type: macroEconomicFactorsSM, required: true },
    market_metrics: { type: marketMetricsSM, required: true },
    technical_indicators: { type: technicalIndicatorsSM, required: true },
  },
  { _id: false }
);
